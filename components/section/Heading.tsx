...
export default function Heading(getData: Props) {
    ...
    return (
        <>
            <div className={`flex items-center justify-start gap-x-2 px-8 py-2 ${getData.colorBackground} ${getData.colorText} w-fit border-l-4 rounded-r-full ${getData.colorBorder}`}>
                {
                    getData.isIcon ?
